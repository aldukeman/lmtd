...
extern vector<SimpleOperator> g_simpleoperators;//added by huym, for landmarks 10-08-09
extern bool g_use_metric;  // added by huym, for ff-heuristic, 10-08-19
extern int g_before_order_option; //10-08-19
...
// for landmark, huym, 10-08-11
struct hash_operator_ptr {
    size_t operator()(const SimpleOperator *key) const {
